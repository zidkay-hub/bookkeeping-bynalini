      ...
      <div className="section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6">
                <div className="bg-navy p-4 rounded-xl text-gold">
                  <Phone size={24} />
                </div>
                <div>
          ...
          <motion.div 
            ...
            className="bg-navy text-white p-8 md:p-10 rounded-2xl shadow-xl border border-navy"
          >
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12">
                ...
                <h3 className="text-2xl font-bold text-gold mb-2">Message Sent!</h3>
                <p className="text-gray-300">Thank you for reaching out. Nalini will get back to you shortly.</p>
                <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-3 rounded-lg border border-white/20 bg-white/10 text-white placeholder-gray-400 focus:outline-none focus:border-gold transition-colors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gold mb-2">Service Interested In</label>
                    <select 
                      name="service"
                ...
                <div className="bg-white/10 p-4 rounded-lg text-xs text-gray-300 border border-white/20">
                  This site is protected by reCAPTCHA and the Google 
                  <a href="#" className="text-gold hover:underline mx-1">Privacy Policy</a> and 
                  <a href="#" className="text-gold hover:underline mx-1">Terms of Service</a> apply.
                </div>
